...
// ---------- Roster de personas (superficie Personas & RH) ----------
const EMPLEADOS = [
  { id: 'EMP-alt-dueña', nombre: 'Dueña / Directora', puesto: 'Dirección', departamento: 'Dirección', estado: 'activo', roles: ['Dirección', 'Perforador'], procesos: ['Informe del día', 'Contabilizar ingresos del mes'], responsabilidades: 'Estrategia, precios, protocolo, contratación y finanzas.', competencias: ['Liderazgo', 'Perforación', 'Gestión'], nomina: 'Retiro de utilidades (PENDIENTE)', kpis: 'Rentabilidad, reseñas, crecimiento', notas: 'Fundadora. Cubre cabina y decide protocolo.' },
  { id: 'EMP-alt-perf1', nombre: 'Perforador/a principal', puesto: 'Perforador/a', departamento: 'Piercings', estado: 'activo', roles: ['Perforador'], procesos: ['Perforación con aguja estéril', 'Asepsia de la zona', 'Asesoría: elegir perforación y joyería'], responsabilidades: 'Ejecutar perforaciones seguras y estéticas; asesorar.', competencias: ['Asepsia', 'Anatomía del piercing', 'Trato al cliente'], nomina: 'Sueldo + comisión por servicio (PENDIENTE)', kpis: 'Reseñas ≥4.7, cicatrización sin incidentes', notas: 'Certificación de RPBI vigente.' },
  { id: 'EMP-alt-recep', nombre: 'Recepcionista', puesto: 'Recepcionista', departamento: 'Recepción', estado: 'activo', roles: ['Recepción', 'Caja'], procesos: ['Recibir al cliente y confirmar cita', 'Cobrar el servicio', 'Enviar cuidados y encuesta por WhatsApp'], responsabilidades: 'Agenda, cobro, seguimiento y redes básicas.', competencias: ['Atención', 'POS', 'WhatsApp/IG'], nomina: 'Sueldo base (PENDIENTE)', kpis: 'Ocupación de agenda, seguimiento post-servicio', notas: '' },
  { id: 'EMP-alt-tat', nombre: 'Vacante — Tatuador/a', puesto: 'Tatuador/a', departamento: 'Tatuajes', estado: 'candidato', roles: ['Tatuador'], procesos: [], responsabilidades: 'Realizar tatuajes con calidad e higiene.', competencias: ['Técnica de tatuaje', 'Diseño', 'Asepsia'], nomina: 'Comisión por trabajo (PENDIENTE)', kpis: 'Reseñas, reincidencia de clientes', notas: 'Buscando por portafolio; hará prueba práctica supervisada.' },
];
